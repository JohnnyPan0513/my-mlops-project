...
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/my-mlops-project/my-mlops-project-model)
* [Prod model in UC](https://adb-4166172131385068.8.azuredatabricks.net/explore/data/models/prod/my-mlops-project/my-mlops-project-model)
. 
