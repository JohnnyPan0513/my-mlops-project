...
2. Update `my_mlops_project/assets/feature-engineering-workflow-asset.yml`. Fill in notebook parameters for `write_feature_table_job`.
3. Update training data path in `my_mlops_project/assets/model-workflow-asset.yml`.
...
Refer to [Local development and dev workspace](../my_mlops_project/assets/README.md#local-development-and-dev-workspace)
